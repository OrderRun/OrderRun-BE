...
@router.get(
    ...
    responses=error_responses(AppError.INVALID_TOKEN, AppError.USER_NOT_FOUND),
)
def get_user_detail(
...
@router.patch(
    ...
    responses=error_responses(AppError.INVALID_TOKEN, AppError.VALIDATION_ERROR, AppError.USER_NOT_FOUND),
)
@router.post(
    "/alarm",
    summary="알림 설정 변경",
